...
def restaurantes(uri, nombre, menu, telefono, direccion, webpage, imagen, mapa, uriatencion, abre, cierra):
    ...
    g.add(( URIRef(uri), UMBEL.isRelatedTo, URIRef(rutaVueltaOriente.Restaurantes)))


restaurantes(
    facebook['pages/Restaurante-El-Mirador-Via-La-Marina/600740703382784'],#uri
    'EL MIRADOR',#nombre
    ...
    "http://i.imgur.com/BJM64TK.jpg",#uriatencion
    "08:00:00",#abre
    "19:00:00"#cierra
)

restaurantes(
    facebook['rancho.jlarivera'],#uri
    'RANCHO J',#nombre
...
restaurantes(
    twitter['765348363785175040'],#uri
