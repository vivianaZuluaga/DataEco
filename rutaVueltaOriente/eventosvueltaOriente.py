...
def eventos(uri, nombre, fecha, descripcion, lugar, media, image, uriTime, mapa, duracion):
	...
	g.add(( URIRef(uri), UMBEL.isRelatedTo, URIRef(rutaVueltaOriente.Eventos)) )

eventos(
	'http://www.tulua.gov.co/sitio.shtml?apc=m1v1--&x=1480713',#uri
...
eventos(
	'http://elperiodicowebregion.blogspot.com.co/2010/09/fiestas-del-campesino-y-la-alegria.html',#uri
...
eventos(
	'http://turismotulua.blogspot.com.co/2014/07/caracterizacion-del-inventario.html',#uri
...
eventos(
	'http://www.eltabloide.com.co/memoria-y-dignidad-campesina-en-la-moralia/',#uri
...
eventos(
	'http://ganecentro.com/noticias/desafio-guerreros-gane-x5/',#uri
	...
	youtube['fNK21W2k6hQ'],#video cambiar
...
eventos(
	facebook['Club-de-parapente-tulua-528121404021970'],#uri
...
eventos(
	'http://elperiodicowebregion.blogspot.com.co/2015/06/desde-el-llano-llegaron-familias.html',#uri
...
eventos(
	'http://www.mtbcolombia.com/noticias/item/el-valle-se-prepara-para-la-valida-nacional',#uri
...
eventos(
	'http://www.eltabloide.com.co/vibra-el-morro-de-el-picacho/',#uri
