...
ciudadGuru = Namespace('http://www.ciudadguru.com.co/empresas/') #Valores con CC
hoteles = Namespace('http://hotel-az.com/viajes-turismo/tulua/')
turismoTulua = Namespace('http://rnttulua.confecamaras.co/detalle-establecimiento/') #Camas - Registro Nacional de Turismo no CC
...
alcaldiaRiofrio = Namespace('http://www.riofrio-valle.gov.co/')

rutaMaiz = Namespace('http://190.14.254.237/dataseteco/RutaDelMaiz/')
rioFrio = Namespace('http://190.14.254.237/dataseteco/Riofrio/')
geonames = Namespace('http://www.geonames.org/')

rutaAnillo = Namespace('http://190.14.254.237/dataseteco/RutaDelAnilloAgricola/')
rutaJardin = Namespace('http://190.14.254.237/dataseteco/RutaDelJardinBotanico/')
rutaVueltaOriente = Namespace('http://190.14.254.237/dataseteco/RutaVueltaAOriente/')
