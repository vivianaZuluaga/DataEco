...
g.add( (URIRef(rutaJardin['descripcion.rdf']), UMBEL.hasCharacteristic, rutaJardin['Alojamientos.rdf']) )
#g.add( (URIRef(rutaJardin['descripcion.rdf']), UMBEL.hasCharacteristic, rutaJardin['Empresas.rdf']) )
#g.add( (URIRef(rutaJardin['descripcion.rdf']), UMBEL.hasCharacteristic, rutaJardin['Eventos.rdf']) )
g.add( (URIRef(rutaJardin['descripcion.rdf']), UMBEL.hasCharacteristic, rutaJardin['Fauna.rdf']) )
g.add( (URIRef(rutaJardin['descripcion.rdf']), UMBEL.hasCharacteristic, rutaJardin['Flora.rdf']) )
g.add( (URIRef(rutaJardin['descripcion.rdf']), UMBEL.hasCharacteristic, rutaJardin['Lugares.rdf']) )
#g.add( (URIRef(rutaJardin['descripcion.rdf']), UMBEL.hasCharacteristic, rutaJardin['Restaurantes.rdf']) )
